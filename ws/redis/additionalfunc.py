...
class agentactivities:
	...
	def getjson(self, jsonname, path='.'):
		try:
			...
			log_message(10,f"response of getjson ={jsonobj}")
			return jsonobj
		except Exception as e:
			return str(e)
	...
	def get_agent(self):
		...
		availableAgent_list = [ {
                                        ...
                                        'agentDetails': {
                                                'id': 'emusonicbzcozw',
                                                'name': 'Henry',
                                                'photo': '/assets/post-login/images/agent.jpg'
                                                }
                                        },
                                        {
                                        'agentAvailable': True,
		...
		availableAgent= random.choice(availableAgent_list)
		log_message(10,f" avilable random agent ={availableAgent}")
